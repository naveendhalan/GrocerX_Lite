                ...
                child: Image.asset(
                  ...
                  errorBuilder: (context, error, stackTrace) {
                    return Container(
                      ...
                      child: Icon(Icons.image_not_supported, size: 100, color: theme.colorScheme.onSurface.withValues(alpha: 0.3)),
                    );
                  },
                ),
              ),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    subtitle,
                    textAlign: TextAlign.center,
                    style: theme.textTheme.bodyLarge?.copyWith(color: theme.colorScheme.onSurface.withValues(alpha: 0.7), height: 1.5),
                  ),
                ),
              ],
            ),
