...
class AddressCard extends StatelessWidget {
  const AddressCard({super.key, required this.address, this.onEdit, this.onDelete});
  ...
  Widget build(BuildContext context) {
    ...
    if (Get.arguments != null) {
      controller.screenName.value = Get.arguments;
    }
    return InkWell(
      onTap: () {
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: address.isDefault ? Border.all(color: theme.colorScheme.primary, width: 2) : null,
        ...
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    ...
                    if (address.isDefault) ...[
                      ...
                      Container(
                        ...
                        child: Text(
                          'Default',
                          style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.onPrimary, fontSize: 10, fontWeight: FontWeight.w600),
                        ),
                      ),
                    ],
                  ],
            ...
            Text(address.fullAddress, style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.onSurface.withValues(alpha: 0.7), height: 1.5)),
            const SizedBox(height: 8),
            Row(
              children: [
                Icon(Icons.phone, size: 16, color: theme.colorScheme.onSurface.withValues(alpha: 0.6)),
                const SizedBox(width: 4),
                Text(address.phone, style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.onSurface.withValues(alpha: 0.6))),
              ],
            ),
          ],
        ),
