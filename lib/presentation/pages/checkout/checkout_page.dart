      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [const CheckoutAddressCard(), const SizedBox(height: 16), const PaymentOptionCard(), const SizedBox(height: 16), const OrderSummaryCard(), const SizedBox(height: 24), const ConfirmOrderButton()],
          ),
        ),
      ),
    );
