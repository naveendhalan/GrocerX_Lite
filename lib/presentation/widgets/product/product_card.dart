          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Obx(() {
                ...
                return IconButton(
                  icon: Icon(isFavorite ? Icons.favorite : Icons.favorite_border, color: isFavorite ? theme.colorScheme.error : theme.colorScheme.onSurface.withValues(alpha: 0.6), size: 20),
                  onPressed: () {
