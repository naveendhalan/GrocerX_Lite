        ...
        child: Stack(
          children: [
                  ...
                  child: Container(
                    ...
                    child: Image.asset(
                      ...
                      errorBuilder: (context, error, stackTrace) {
                        return Icon(Icons.image_not_supported, size: 50, color: theme.colorScheme.onSurface.withValues(alpha: 0.3));
                      },
                    ),
                  ),
                ),
            ...
            Positioned(
              ...
              child: Obx(
                () => IconButton(
                  icon: Icon(controller.isInWishlist(product) ? Icons.favorite : Icons.favorite_border, color: controller.isInWishlist(product) ? theme.colorScheme.error : theme.colorScheme.onSurface.withValues(alpha: 0.6)),
