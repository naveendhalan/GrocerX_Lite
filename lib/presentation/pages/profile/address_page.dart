          ...
          () => controller.addresses.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.location_off, size: 64, color: theme.colorScheme.onSurface.withValues(alpha: 0.3)),
                      const SizedBox(height: 16),
                      Text('No addresses added yet', style: theme.textTheme.bodyLarge?.copyWith(color: theme.colorScheme.onSurface.withValues(alpha: 0.6))),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text('Are you sure you want to delete "${address.title}" address?', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.onSurface.withValues(alpha: 0.7))),
              const SizedBox(height: 24),
              Row(
                children: [
                  Expanded(
